...
export const Other = ({ data, products, setProducts, basket, setBasket, counter, setCounter }) => {

  const handleIncrement = (index) => {
    setProducts((prevProducts) => {
      const updatedOther = [...prevProducts.other];
      ...
      return { ...prevProducts, other: updatedOther };
    });
  };

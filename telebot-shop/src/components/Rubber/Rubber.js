...
export const Rubber = ({ data, products, setProducts, basket, setBasket, counter, setCounter }) => {

  const handleIncrement = (index) => {
    setProducts((prevProducts) => {
      const updatedRubber = [...prevProducts.rubber];
      const updatedItem = { ...updatedRubber[index] };

      updatedRubber[index] = updatedItem;
      ...
      return { ...prevProducts, rubber: updatedRubber };
    });
  };
    ...
    <div>
      <div className='main-products-block'>
        ...
        <div className='product-card-block'>
          {products.rubber.map((item, index) => {
            return (

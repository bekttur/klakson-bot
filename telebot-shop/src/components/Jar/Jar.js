...
export const Jar = ({ data, products, setProducts, basket, setBasket, counter, setCounter }) => {

  const handleIncrement = (index) => {
    setProducts((prevProducts) => {
      const updatedJar = [...prevProducts.jar];
      const updatedItem = { ...updatedJar[index] };

      updatedJar[index] = updatedItem;
      ...
      return { ...prevProducts, jar: updatedJar };
    });
  };
                  ...
                  {item.count !== 0 && (
                    <>
                      <div className='second-image-container'>
                        <img style={{ height: "60%" }} src={item.img} alt='Product' />

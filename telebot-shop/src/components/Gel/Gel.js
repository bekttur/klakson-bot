...
export const Gel = ({ data, products, setProducts, basket, setBasket, counter, setCounter }) => {

  const handleIncrement = (index) => {
    setProducts((prevProducts) => {
      const updatedGel = [...prevProducts.gel];
      const updatedItem = { ...updatedGel[index] };

      updatedGel[index] = updatedItem;
      ...
      return { ...prevProducts, gel: updatedGel };
    });
  };
              ...
              <div className='card' key={index}>
                ...
                <div className='image__container'>
                  {item.count !== 0 && (
                    ...
                    <img src={item.img} style={{ width: "80%" }} alt='Product' />
                    )}
                </div>

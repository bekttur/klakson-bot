...
export const Liquid = ({ data, products, setProducts, basket, setBasket, counter, setCounter }) => {


  const handleIncrement = (index) => {
    setProducts((prevProducts) => {
      const updatedLiquid = [...prevProducts.liquid];
      const updatedItem = { ...updatedLiquid[index] };

      updatedLiquid[index] = updatedItem;
      ...
      return { ...prevProducts, liquid: updatedLiquid };
    });
  };
    ...
    <div>
      <div className='main-products-block'>
        ...
        <div className='product-card-block'>
          {products.liquid.map((item, index) => {
            return (

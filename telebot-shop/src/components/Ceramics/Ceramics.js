...
export const Ceramics = ({ data, products, setProducts, basket, setBasket, counter, setCounter }) => {

  const handleIncrement = (index) => {
    setProducts((prevProducts) => {
      const updatedCeramics = [...prevProducts.ceramics];
      const updatedItem = { ...updatedCeramics[index] };

      updatedCeramics[index] = updatedItem;
      ...
      return { ...prevProducts, ceramics: updatedCeramics };
    });
  };
    ...
    <div>
      <div className='main-products-block'>
        ...
        <div className='product-card-block'>
          {products.ceramics.map((item, index) => {
            return (
